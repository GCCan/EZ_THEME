...
export default {
    ...
    landing: {
        ...
        featureSpeed: '高速稳定',
        featureSpeedDesc: '提供千兆带宽与专线接入，确保低延迟与极速流畅的网络体验。',
        featureGlobal: '全球互联',
        featureGlobalDesc: '覆盖全球多个国家和地区，海量节点随时随地畅游无界网络。',
        featureSecurity: '隐私安全',
        featureSecurityDesc: '采用工业级强加密技术，全方位保护您的个人隐私与数据安全。',
        scrollMore: '了解更多',
        enterPanel: '开始体验',
        plansTitle: '选择适合您的套餐',
