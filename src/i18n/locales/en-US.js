...
export default {
    ...
    landing: {
        ...
        introSubtitle: 'We are committed to providing global users with high-quality network acceleration services, making connections everywhere.',
        featureSpeed: 'High-Speed & Stable',
        featureSpeedDesc: 'Providing gigabit bandwidth and dedicated lines to ensure low latency and a blazing fast network experience.',
        featureGlobal: 'Global Connection',
        featureGlobalDesc: 'Covering multiple countries and regions globally, massive nodes let you surf the borderless internet anytime, anywhere.',
        featureSecurity: 'Privacy & Security',
        featureSecurityDesc: 'Adopting industrial-grade strong encryption technology to comprehensively protect your personal privacy and data security.',
